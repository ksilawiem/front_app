...
<template>
    ...
    <div class="titre">Plus que 100 tests à découvrir</div>
    ...
    <div class="d-flex flex-wrap" >
        <CContainer class="size1" v-for="categorie in filtredcategorie" :key="categorie.id">
           ...
           <i class="fa fa-pencil-square-o" v-if="user.role=='admin'" @click="sendcategorie(categorie.id)" style="color:black;margin-left:250px;"></i>
           <i class="fa fa-trash" v-if="user.role=='admin'" @click="supprcategorie(categorie.id)" style="color:red;margin-left:10px;"></i>
