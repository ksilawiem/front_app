  ...
  <table class="t">
    ...
    <tr>
      <td><label id="lDisplayPerPg" for="lDisplayPerPg">Items per page :</label>
        <select class="select2" name="listDisplayPerPg" id="listDisplayPerPg">
      ...
      <CTableRow v-for="user in filtredUser" :key="user.id">
        ...
        <CTableDataCell class="etat" @click="profilsend(user.id)">
         ...
         <a :href="user.cv" target="_blank"
          ><CTableDataCell class="etat">cv</CTableDataCell></a
        >
